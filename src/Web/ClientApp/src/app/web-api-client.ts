...
export interface ICashTransactionsClient {
    getCashTransactions(pageNumber: number, pageSize: number): Observable<PaginatedListOfCashTransactionDto>;
    createCashTransaction(command: CreateCashTransactionCommand): Observable<number>;
    updateCashTransaction(id: number, command: UpdateCashTransactionCommand): Observable<void>;
...
export class CashTransactionsClient implements ICashTransactionsClient {
    ...
    getCashTransactions(pageNumber: number, pageSize: number): Observable<PaginatedListOfCashTransactionDto> {
        let url_ = this.baseUrl + "/api/CashTransactions?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCashTransactions(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCashTransactions(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PaginatedListOfCashTransactionDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PaginatedListOfCashTransactionDto>;
        }));
    }

    protected processGetCashTransactions(response: HttpResponseBase): Observable<PaginatedListOfCashTransactionDto> {
        ...
        if (status === 200) {
            ...
            result200 = PaginatedListOfCashTransactionDto.fromJS(resultData200);
    ...
    createCashTransaction(command: CreateCashTransactionCommand): Observable<number> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateCashTransaction(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateCashTransaction(response_ as any);
                } catch (e) {
    ...
    protected processCreateCashTransaction(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    updateCashTransaction(id: number, command: UpdateCashTransactionCommand): Observable<void> {
        let url_ = this.baseUrl + "/api/CashTransactions/{id}";
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateCashTransaction(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateCashTransaction(response_ as any);
                } catch (e) {
    ...
    protected processUpdateCashTransaction(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    deleteCashTransaction(id: number): Observable<void> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteCashTransaction(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteCashTransaction(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processDeleteCashTransaction(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface ISalesClient {
    getSales(pageNumber: number, pageSize: number, startDate: Date | null | undefined, endDate: Date | null | undefined, customerName: string | null | undefined, categoryId: number | null | undefined): Observable<PaginatedListOfSaleDto>;
...
export class SalesClient implements ISalesClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PaginatedListOfSaleDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PaginatedListOfSaleDto>;
        }));
    }

    protected processGetSales(response: HttpResponseBase): Observable<PaginatedListOfSaleDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PaginatedListOfSaleDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    createSale(command: CreateSaleCommand): Observable<number> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateSale(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<number>;
                }
            } else
    ...
    protected processCreateSale(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class PaginatedListOfCashTransactionDto implements IPaginatedListOfCashTransactionDto {
    ...
    constructor(data?: IPaginatedListOfCashTransactionDto) {
        if (data) {
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items!.push(CashTransactionDto.fromJS(item));
            }
    ...
    static fromJS(data: any): PaginatedListOfCashTransactionDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedListOfCashTransactionDto();
        result.init(data);
        return result;
    }
...
export interface IPaginatedListOfCashTransactionDto {
    items?: CashTransactionDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class CashTransactionDto implements ICashTransactionDto {
    id?: number;
    ...
    constructor(data?: ICashTransactionDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CashTransactionDto {
        data = typeof data === 'object' ? data : {};
        let result = new CashTransactionDto();
        result.init(data);
        return result;
    }
...
export interface ICashTransactionDto {
    id?: number;
    transactionDate?: Date;
    amount?: number;
    transactionType?: CashTransactionType;
...
export enum CashTransactionSource {
    Cash = 0,
    Bank = 1,
    Pos = 2,
}

export class CreateCashTransactionCommand implements ICreateCashTransactionCommand {
    transactionDate?: Date;
    amount?: number;
    transactionType?: CashTransactionType;
    source?: CashTransactionSource;
    ...
    constructor(data?: ICreateCashTransactionCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateCashTransactionCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateCashTransactionCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateCashTransactionCommand {
    transactionDate?: Date;
    amount?: number;
    transactionType?: CashTransactionType;
    source?: CashTransactionSource;
...
export class UpdateCashTransactionCommand implements IUpdateCashTransactionCommand {
    id?: number;
    transactionDate?: Date;
    amount?: number;
    transactionType?: CashTransactionType;
    ...
    constructor(data?: IUpdateCashTransactionCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateCashTransactionCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateCashTransactionCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateCashTransactionCommand {
    id?: number;
    transactionDate?: Date;
    amount?: number;
    transactionType?: CashTransactionType;
...
export class PaginatedListOfSaleDto implements IPaginatedListOfSaleDto {
    ...
    constructor(data?: IPaginatedListOfSaleDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PaginatedListOfSaleDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedListOfSaleDto();
        result.init(data);
        return result;
    }
...
export interface IPaginatedListOfSaleDto {
    items?: SaleDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
